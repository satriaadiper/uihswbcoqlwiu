...
Report this at @FileUnzip_Chat and tag the @Admin
    """
...
# __main__.py
    ...
    BOT_RUNNING = "Bot is running now ! Join @FileUnzip_Chat"
...
Please report this at @FileUnzip_Chat if you think this is a serious error
    """
...
**URL :** `{}`
    ...
    START_TEXT = """
Hello **{}**! 👋, Welcome to **File Unzip Bot™** 🔐
I'm here to help you unzip your files.

Simply send me a zip file, and I'll extract its contents for you. 
You can also provide a direct URL to a zip file, and I'll handle it for you. 

I can extract archives like `zip`, `rar`, `tar`, …
**[DIRECT URL//LINK SUPPORTED]**
...
**• I wanna have help 🥺**
    ...
    PM me at **@FileUnzip_Chat**
    """

    ABOUT_TXT = """
**About **File Unzip Bot™** 🔐**
...
Please report this at @UnzipBot_chat if you think this is a serious error
    """
...
If you believe it's an error, send the file to **@FileUnzip_Chat**
    """
...
Please contact @FileUnzip_Chat with details and screenshots
    """
...
If it fails again, it means that {} haven't started the bot yet (or deleted the chat), or he's private/banned/whatever
    ...
    REPORT_REPLY = "Reply to a message to report it to @FileUnzip_Chat"

    REPORT_DONE = """
Report sucessfully sent ! An answer will arrive soon

Note : if you need to reply to replies, always use that /report command (or join **@FileUnzip_Chat**)
    """
...
**/logs** : Send you the logs (all of them). Useful for bug tracking. Send them to **@FileUnzip_Chat** if you don't understand them/need help
